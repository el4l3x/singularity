                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route("servicios.store") }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <x-adminlte-input data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'prefix': '$ ', 'placeholder': '0', 'removeMaskOnSubmit': true" inputmode="decimal" name="precio" label="Precio" placeholder="" enable-old-support maxlength="9" fgroup-class="col-lg-6 col-md-6 col-sm-12">
                                <x-slot name="bottomSlot">
                                    @error('precio')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
