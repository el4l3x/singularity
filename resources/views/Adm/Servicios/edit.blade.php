                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route("servicios.update", $servicio) }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <x-adminlte-input name="nombre" label="Nombre" placeholder="" enable-old-support fgroup-class="col-lg-6 col-md-6 col-sm-12" value="{{ $servicio->nombre }}">
                            ...
                            <x-adminlte-input name="precio" label="Precio" placeholder="" enable-old-support fgroup-class="col-lg-6 col-md-6 col-sm-12" value="{{ $servicio->precio }}">
                                <x-slot name="bottomSlot">
                                    @error('precio')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                @else
                                    @foreach ($tags as $tag)
                                        @php
                                            $breed = false;
                                        @endphp
                                        @foreach ($servicio->tags as $serviciot)
                                            @if ($serviciot->pivot->tag_id == $tag->id)
